...
CREATE TABLE `api`  (
  ...
  `ctime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '2021-01-25 21:49:31' COMMENT '创建时间',
  `mtime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '2021-01-25 21:49:31' COMMENT '更新时间',
...
-- Records of api
-- ----------------------------
INSERT INTO `api` VALUES ('3c0b86d4-e402-487a-856c-cef073329c29', '新增角色', '/api/role/add', 'POST', 'ada58122-a724-4f49-873c-bf96aa993418', '2021-01-25 21:36:26', '2021-01-25 21:38:17', NULL);
INSERT INTO `api` VALUES ('6b1c0c99-0b1f-49c3-9070-a31d54012d22', '角色详情', '/api/role/detail/:id', 'GET', 'ada58122-a724-4f49-873c-bf96aa993418', '2021-01-25 21:42:28', '2021-01-25 21:42:28', '默认备注信息....');
...
INSERT INTO `api_type` VALUES ('ffce7eda-2e27-4473-8fc1-d3a3f4caf39a', '接口类别管理', 1, '接口类别管理类别', '2021-01-25 21:08:47', '2021-01-25 21:08:47');
...
CREATE TABLE `icon`  (
  ...
  `ctime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '2021-01-25 21:49:31' COMMENT '创建时间',
  `mtime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '2021-01-25 21:49:31' COMMENT '图标更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `menu`  (
  ...
  `ctime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '2021-01-25 21:49:31' COMMENT '菜单创建时间',
  `mtime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '2021-01-25 21:49:31' COMMENT '菜单更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `pid`(`pid`) USING BTREE,
...
INSERT INTO `menu` VALUES ('bc262ac5-d198-4fcc-8fdc-7459bdc538ad', '用户管理', 'd6aa09e9-a1b7-47fb-b073-311e873af633', 1, '/system/user', '/system/user/List', 2, 0, 1, 1, 'el-icon-user', '系统管理 - 用户管理', '2021-01-15 10:10:02', '2021-01-20 13:31:14');
...
INSERT INTO `menu` VALUES ('fdf1ab35-dab2-402f-911a-9e9eb2cfadd4', '接口管理', 'd6aa09e9-a1b7-47fb-b073-311e873af633', 1, '/system/api', '/system/api/List', 2, 0, 1, 1, 'el-icon-lock', '系统管理 - 接口管理', '2021-01-25 11:34:41', '2021-01-25 11:34:41');
...
CREATE TABLE `role`  (
  ...
  `ctime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '2021-01-25 21:49:31' COMMENT '创建时间',
  `mtime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '2021-01-25 21:49:31' COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `user`  (
  ...
  `ctime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '2021-01-25 21:49:31' COMMENT '用户创建时间',
