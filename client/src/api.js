...
// 这样做的方法是为了如果有多个后台
const baseURL = [window.g.ip + '/api', 'http://data.zz.baidu.com']
...
const list = {
  ...
  */
  ...
  SaveResource: { method: 'post', url: '/resource/saveImg' },
  ...
  */
  ...
  GetTaskLog: { method: 'get', url: '/task/logs' },

  /**
   * 仪表盘管理
  */
  // 新增仪表盘 请求类型：post 请求地址：/dash/add
  AddDash: { method: 'post', url: '/dash/add' },
  // 更新仪表盘 请求类型：put 请求地址：/dash/update
  UpdateDash: { method: 'put', url: '/dash/update' },
  // 仪表盘详情 请求类型：get 请求地址：/dash/detail
  GetDash: { method: 'get', url: '/dash/detail' },
  // 仪表盘列表 请求类型：get 请求地址：/dash/list
  GetDashs: { method: 'get', url: '/dash/list' },
  // 根据标识获取仪表盘 请求类型：get 请求地址：/dash/getByIdentify
  GetDashByIdentify: { method: 'get', url: '/dash/getByIdentify' },
  // 删除仪表盘 请求类型：delete 请求地址：/dash/deleteById
  DeleteDash: { method: 'delete', url: '/dash/deleteById' },

  /**
   * 图表管理
  */
  // 图表列表 请求类型：get 请求地址：/chart/list
  GetCharts: { method: 'get', url: '/chart/list' },
  // 新增图表 请求类型：post 请求地址：/chart/add
  AddChart: { method: 'post', url: '/chart/add' },
  // 删除图表 请求类型：delete 请求地址：/chart/deleteById
  DeleteChart: { method: 'delete', url: '/chart/deleteById' },
  // 图表详情 请求类型：get 请求地址：/chart/detail
  GetChart: { method: 'get', url: '/chart/detail' },
  // 更新图表 请求类型：put 请求地址：/chart/update
  UpdateChart: { method: 'put', url: '/chart/update' },

  /**
   * 项目管理
  */
  // 项目列表 请求类型：get 请求地址：/project/list
  GetProjects: { method: 'get', url: '/project/list' },
  // 新增项目 请求类型：post 请求地址：/project/add
  AddProject: { method: 'post', url: '/project/add' },
  // 项目详情 请求类型：get 请求地址：/project/detail
  GetProject: { method: 'get', url: '/project/detail' },
  // 更新项目 请求类型：put 请求地址：/project/update
  UpdateProject: { method: 'put', url: '/project/update' },
  // 删除项目 请求类型：delete 请求地址：/project/deleteById
  DeleteProject: { method: 'delete', url: '/project/deleteById' },
  // 删除项目 请求类型：get 请求地址：/project/download
  DownloadProject: { method: 'get', url: '/project/download' },
  /**
   * 项目图集
  */
  // 项目图集列表 请求类型：get 请求地址：/pimage/list
  GetProjectImages: { method: 'get', url: '/pimage/list' },
  // 新增项目图集 请求类型：post 请求地址：/pimage/upload
  AddProjectImage: { method: 'post', url: '/pimage/upload' },
  // 更新项目图集 请求类型：put 请求地址：/pimage/update
  UpdateProjectImage: { method: 'put', url: '/pimage/update' },
  // 删除项目图集 请求类型：delete 请求地址：/pimage/deleteById
  DeleteProjectImage: { method: 'delete', url: '/pimage/deleteById' },
  // 项目图集详情 请求类型：get 请求地址：/pimage/detail
  GetProjectImage: { method: 'get', url: '/pimage/detail' },
  /**
   * 项目文档
  */
  // 项目文档列表 请求类型：get 请求地址：/pdocument/list
  GetProjectDocuments: { method: 'get', url: '/pdocument/list' },
  // 新增项目文档 请求类型：post 请求地址：/pdocument/upload
  AddProjectDocument: { method: 'post', url: '/pdocument/add' },
  // 更新项目文档 请求类型：put 请求地址：/pdocument/update
  UpdateProjectDocument: { method: 'put', url: '/pdocument/update' },
  // 删除项目文档 请求类型：delete 请求地址：/pdocument/deleteById
  DeleteProjectDocument: { method: 'delete', url: '/pdocument/deleteById' },
  // 项目文档详情 请求类型：get 请求地址：/pdocument/detail
  GetProjectDocument: { method: 'get', url: '/pdocument/detail' },
  /**
   * 项目任务
  */
  // 项目任务列表 请求类型：get 请求地址：/pissue/list
  GetProjectIssues: { method: 'get', url: '/pissue/list' },
  // 更新项目任务 请求类型：put 请求地址：/pissue/update
  UpdateProjectIssue: { method: 'put', url: '/pissue/update' },
  // 项目任务详情 请求类型：get 请求地址：/pissue/detail
  GetProjectIssue: { method: 'get', url: '/pissue/detail' },
  // 新增项目任务 请求类型：post 请求地址：/pissue/add
  AddProjectIssue: { method: 'post', url: '/pissue/add' },
  // 删除项目任务 请求类型：delete 请求地址：/pissue/deleteById
  DeleteProjectIssue: { method: 'delete', url: '/pissue/deleteById' },
  /**
   * 日志管理
  */
  // 日志列表 请求类型：get 请求地址：/log/list
  GetLogs: { method: 'get', url: '/log/list' },
  // 删除项目任务 请求类型：delete 请求地址：/log/deleteById
  DeleteLog: { method: 'delete', url: '/log/deleteById' },
  ...
  */
  ...
  // 获取公钥 请求类型：post 请求地址：/pke
  GetPublicKey: { method: 'post', url: '/pke' },
  ...
  GetIP: { method: 'get', url: '/' },

  /**
   * 百度收录接口
  */
  // 百度收录 请求类型：get 请求地址：/urls
  BaiduIncluded: { method: 'post', url: '/tool/baidu' }
}
...
export default (config) => {
  return new Promise((resolve, reject) => {
    ...
    if (config.requireAuth) {
      requestConfig.headers[CRYPTO_PADDING.token] = Cookies.get(CRYPTO_PADDING.token)
    }

    // 发送请求
    http(requestConfig).then(res => {
      if (res.headers && res.headers[CRYPTO_PADDING.token]) {
        Cookies.set(CRYPTO_PADDING.token, res.headers[CRYPTO_PADDING.token])
      }
